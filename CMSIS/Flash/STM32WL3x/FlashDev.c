...
#ifdef STM32WL3x_256K
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "STM32WL3x_256K Flash",        // Device Name (1024kB)
   ONCHIP,                     // Device Type
   0x10040000,                 // Device Start Address
   0x00040000,                 // Device Size in Bytes (1024kB)
...
#endif
#ifdef STM32WL3x_128K
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "STM32WL3x_128K Flash",        // Device Name (1024kB)
   ONCHIP,                     // Device Type
   0x10040000,                 // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "STM32WL3x_64K Flash",        // Device Name (1024kB)
   ONCHIP,                     // Device Type
   0x10040000,                 // Device Start Address
